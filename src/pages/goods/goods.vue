...
const onChangeSwiper: UniHelper.SwiperOnChange = (ev: UniHelper.SwiperOnChangeEvent) => {
...
<template>
  ...
  <scroll-view scroll-y class="viewport">
    ...
    <view class="goods">
      <!-- 商品主图 -->
      <view class="preview">
        <swiper @change="onChangeSwiper" circular>
      ...
      <view class="meta">
        ...
        <view class="desc ellipsis">{{ goods?.desc }}</view>
      </view>
      ...
      <view class="action">
        ...
        <view @tap="openPopup('address')" class="item arrow">
          ...
          <text class="text ellipsis">
            {{ selectedAddress ? selectedAddress.fullLocation : '请选择收获地址' }}
          </text>
        </view>
