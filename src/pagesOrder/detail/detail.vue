...
onReady(() => {
  ...
  currentPage.animate(
    ...
    1000,
    { scrollSource: '#scroller', timeRange: 1000, startScrollOffset: 0, endScrollOffset: 50 },
  )

  currentPage.animate('.navbar .title', [{ color: 'transparent' }, { color: '#000' }], 1000, {
  ...
  currentPage.animate('.navbar .back', [{ color: '#fff' }, { color: '#000' }], 1000, {
    scrollSource: '#scroller',
    timeRange: 1000,
    startScrollOffset: 0,
    endScrollOffset: 50,
